...
class PtyBridge:
    ...
    def spawn(
        ...
        *,
        ...
        # PTY children expect TERM to be set (curses, tput, ncurses-based
        # apps refuse to start without it). CI runners and some daemon
        # contexts have no TERM, so guarantee a sane default here rather
